...
const options: { id: string; btn: string; text: string }[] = [
  ...
  },
  {
    ...
    text:
      'Исследование ROCKET AF (n=14,264)\n' +
      'Ривароксабан не уступал варфарину варфарину в отношении профилактики инсульта [ШЕА13.1]\n' +
      '  ↓ Внутричерепные кровоизлияния на 33% vs варфарин (p=0.02)\n' +
      '  ↓ Фатальные кровотечения на 50% vs варфарин (p=0.003)\n',
  },
  {
    id: '3',
