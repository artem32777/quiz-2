...
const items: { id: string; text: string }[] = [
  {
    id: 'Ривароксабан',
    text: 'снижение дозы до 15 мг в сутки происходит на основании сниженной функции почек 15 - 49 мл/мин. Соблюдения никаких других дополнительных условий не требуется. Нашему пациента показана доза 15 мг 1 раз в сутки, так как КК 45 мл/ мин. ',
  },
  {
    id: 'Апиксабан',
    text: 'снижение дозы до 2,5 мг 2 раза в сутки (т.е. 5 мг в сутки) происходит при наличии сочетания двух или более из следующих характеристик – возраст 80 лет и старше, масса тела 60 кг и менее или концентрация креатинина в плазме крови ≥ 1,5 мг/дл (133 мкмоль/л). Нашему пациента показана доза по 5 мг 2 раз в сутки, так как есть единственный критерий - концентрация креатинина в плазме крови 155 мкмоль/л, но отсутствуют другие критерии снижения.',
  },
  {
    id: 'Дабигатран',
