...
<template>
  ...
  >
    <div class="text">
      ...
      пациентов с когнитивными нарушениями или пожилых. [6,7] Рекомендация: Рассмотрите переход на
      ПОАК с однократным приемом (например, ривароксабан) для повышения приверженности.
    </div>
  </Text>
</template>
