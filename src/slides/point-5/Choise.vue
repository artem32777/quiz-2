...
const options: { id: string; description: string; text: string }[] = [
  {
    ...
    text: 'При удалении ≤ 3 зубов и планируемой продолжительностью процедуры менее 45 минут продолжаем прием ПОАК. риски кровотечений минимальны, но отмена препарата приведет к повышению риска тромбозов. Выберите другой вариант.',
  },
  {
    ...
    text: 'При удалении ≤ 3 зубов и планируемой продолжительностью процедуры менее 45 минут продолжаем прием ПОАК. Очередная доза ПОАК должна быть принята за 4 - 10 часов до процедуры. Обязательны местные гемостатические меры. Следующий прием антикоагулянта после процедуры в обычное время. Пример: ривароксабан 20 (15) мг вечером накануне, утром экстракция зубов, вечером прием ривароксабана в день выполнения процедуры. Если используется ПОАК с 2х кратным приемом, то принимается обычная вечерняя доза вечером накануне, утренний прием препарата пропускается в день удаления зубов, а вечером в день выполнения процедуры принимают обычную дозу.',
  },
  {
    id: '«МОСТ-ТЕРАПИЯ»',
    description:
      'Отменяем за 1 день до экстракции зубов с назначением НМГ. Возобновляем прием антикоагулянтов через 24 - 36 часов после процедуры с одновременной отменой НМГ.',
